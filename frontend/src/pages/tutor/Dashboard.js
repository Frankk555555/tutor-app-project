                    ...
                    <>
                        ...
                        <div className="dashboard-section">
                            ...
                            <form onSubmit={handleRecurringSubmit} className="availability-form recurring-form">
                                <h4>สร้างตารางเวลาแบบเฉพาะวัน</h4>
                            ...
                            <form onSubmit={handleAddAvailability} className="availability-form">
                                ...
                                <input type="date" value={newSlot.available_date} onChange={(e) => setNewSlot({...newSlot, available_date: e.target.value})} required />
                                ...
                                <button type="submit" className="btn btn-save">เพิ่มเวลา</button>
                            </form>
